 ...
 */
- (void)trackViewScreen:(UIViewController *)viewController isViewAAppear:(BOOL)ViewIn;
- (void)trackViewScreen:(UIViewController *)viewController properties:(nullable NSDictionary<NSString *,id> *)properties isViewAAppear:(BOOL)ViewIn;
